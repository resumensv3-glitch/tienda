            ...
            <div class="modal-content">
              <form method="POST">
                ...
                <div class="modal-body">
                  ...
                  <input type="text" name="nombre" class="form-control mb-2" value="<?= $row['nombre'] ?>" placeholder="Ingrese el Nombre" required>
                  <input type="text" name="apellido" class="form-control mb-2" value="<?= $row['apellido'] ?>"  placeholder="Ingrese el apellido" required>
                  <input type="email" name="email" class="form-control mb-2" value="<?= $row['email'] ?>" placeholder="Ingrese email">
                  <input type="text" name="telefono" class="form-control mb-2" value="<?= $row['telefono'] ?>" placeholder="Ingrese el telefono">
